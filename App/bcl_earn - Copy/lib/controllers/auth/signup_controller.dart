...
import 'package:bcl_earn/service/device_service.dart';
...
class SignUpController extends GetxController {
  ...
  signUp() {
    if (formKeySignUp.currentState.validate()) {
      ...
      MyDeviceInfoHelper().getDeviceInfo().then((did) {
        DeviceService().checkDevice().then((exist) {
          if (!exist) {
            if (xFile == null) {
              SignUpService()
                  .signUp(mobileController.text + "@gmail.com",
                ...
                if (user != null) {
                  ...
                  SignUpService().createUser(myUser).then((value) {
                    ...
                    DeviceService()
                        .addDevice(myUser.mobile, myUser.uid)
                        .then((value) => Get.to(() => MyLoginPage()));
